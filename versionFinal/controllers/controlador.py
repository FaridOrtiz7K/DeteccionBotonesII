...
class ScriptController:
    ...
    def process_row(self, row, line_number):
        ...
        # Esta función implementa la lógica específica de tu script
        ...
        # Ejemplo de implementación (debes completar con tu lógica específica)
        ...
        # Continuar con el resto de la lógica según tu script original...
        # Implementa aquí todas las acciones específicas
        
        # Ejemplo de lógica condicional
        if pd.notna(row.iloc[4]) and row.iloc[4] > 0:  # Columna D
            pyautogui.click(1507, 650)  # Seleccionar punto USO
            time.sleep(2.5)
            
            for _ in range(int(row.iloc[4])):
