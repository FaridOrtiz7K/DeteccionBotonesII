...
class NSEServicesAutomation:
    def __init__(self, csv_file, linea_especifica=None):
        """
        Inicializa la automatización de servicios NSE.
        ...
        # Coordenadas absolutas de referencia (se actualizarán cuando se detecte la ventana)
        self.coords = {
    ...
    def buscar_imagen(self, imagen_path, timeout=30, confidence=0.8):
        """
        Busca una imagen en la pantalla y retorna sus coordenadas si la encuentra.
        """
    ...
    def actualizar_coordenadas_relativas(self, referencia):
        """
        Calcula coordenadas relativas a partir de la referencia (esquina superior izquierda de la ventana).
        """
        ...
        # Mantener algunos como absolutos
    ...
    def iniciar_ahk(self):
        """Inicia todos los servicios AHK necesarios."""
        try:
    ...
    def detener_ahk(self):
        """Detiene todos los servicios AHK."""
        try:
    ...
    def write(self, text):
        """
        Escribe texto en el campo de cantidad usando coordenadas relativas si están disponibles.
        """
        try:
    ...
    def press_down(self, x, y, times=1):
        """
        Presiona la tecla DOWN después de hacer clic en las coordenadas dadas.
        """
        try:
            if hasattr(self, 'coords_relativas') and self.coords_relativas:
                click_coords = (x, y)
    ...
    def procesar_linea_especifica(self):
        """
        Procesa la línea específica ejecutando los servicios correspondientes.
        ...
        try:
            ...
            # Verificar si hay servicios para procesar (columna 18, índice 17)
            if pd.notna(row.iloc[17]) and row.iloc[17] > 0:
                ...
                # Definición de servicios: (columna, método, nombre)
                servicios = [
                ...
                logger.info(f"⏭️  Línea {self.current_line} no tiene servicios para procesar")
                return True
    ...
    # Métodos para cada tipo de servicio (igual que en el original)
    def handle_voz_cobre(self, cantidad):
        self.click(*self.coords_relativas['menu_principal'])
        self.sleep(3)
        self.write(cantidad)
        logger.info(f"Escribió cantidad de VOZ COBRE TELMEX: {cantidad}")
        self.sleep(3)
    ...
    def handle_datos_sdom(self, cantidad):
        ...
        logger.info(f"Escribió cantidad de DATOS S/DOM: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_datos_cobre_telmex(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de DATOS COBRE TELMEX: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_datos_fibra_telmex(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de DATOS FIBRA TELMEX: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_tv_cable_otros(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de TV CABLE OTROS: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_dish(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de DISH: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_tvs(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de TVS: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_sky(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de SKY: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()
    ...
    def handle_vetv(self, cantidad):
        ...
        self.sleep(3)
        self.write(str(int(cantidad)))
        logger.info(f"Escribió cantidad de VETV: {cantidad}")
        self.sleep(3)
        self.click(*self.coords_relativas['boton_guardar'])
        self.sleep(3)
        self.handle_error_click()