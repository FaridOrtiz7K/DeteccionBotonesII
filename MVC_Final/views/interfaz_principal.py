...
class InterfazPrincipal:
    ...
    def setup_ui(self):
        ...
        self.btn_prueba = ttk.Button(extra_frame, text="Escribir PRUEBA A")
        self.btn_prueba.grid(row=0, column=0, padx=5)
        
        self.btn_kml = ttk.Button(extra_frame, text="Configurar KML")
        self.btn_kml.grid(row=0, column=1, padx=5)
    ...
    # Los siguientes métodos son placeholders, serán reemplazados por el controlador
